...
<div id="modalFilamento" class="modal" hidden>
    <div class="card modal-caixa" role="dialog" aria-modal="true" aria-labelledby="filTituloModal">
...
<div id="modalEntradaLote" class="modal" hidden>
    <div class="card modal-caixa" role="dialog" aria-modal="true" aria-labelledby="loteTituloModal">
...
<div id="modalAjusteFilamento" class="modal" hidden>
    <div class="card modal-caixa" role="dialog" aria-modal="true" aria-labelledby="ajusteTituloModal">
...
<div id="modalDetalhesFilamento" class="modal" hidden>
    <div class="card modal-caixa modal-largo" role="dialog" aria-modal="true" aria-labelledby="detTituloModal">
        ...
        <h3 style="font-size: 14px; margin: 12px 0 6px 0;">📦 Lotes de Compra (Ordem Cronológica PEPS)</h3>
        ...
        <h3 style="font-size: 14px; margin: 12px 0 6px 0;">📜 Extrato Recente de Movimentações</h3>
